  ...
  const renderCuttingProcess = () => {
    ...
    return (
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 h-full">
        {/* --- COLUNA ESQUERDA: LISTA DE BOBINAS MÃE --- */}
        ...
        {/* --- COLUNA DIREITA: AÇÃO, PLANO E HISTÓRICO --- */}
        <div className="lg:col-span-8 flex flex-col gap-6 h-full">
           {selectedMother ? (
             <>
               {/* 1. CABEÇALHO DA BOBINA SELECIONADA */}
               ...
               <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  {/* 2. CARD DE ADICIONAR (COM INTERRUPTOR DE MODO) */}
                  <Card>
                    ...
                    <div className="space-y-4">
                      {isOtherMode ? (
                          ...
                          <div className="bg-amber-900/10 p-4 rounded-lg border border-amber-500/30 animate-fade-in">
                              <p className="text-xs text-amber-200/70 mb-4">
                                  Use esta opção para consumir a matéria prima <strong>sem gerar bobinas filhas no estoque</strong>.
                              </p>
                          ...
                          <div className="animate-fade-in">
                              ...
                              {cutWeight && cutQuantity && (
                                  <div className="text-xs text-center bg-gray-900 p-2 rounded text-blue-300 border border-blue-900/30 mt-2">
             ...
             <div className="flex-1 flex flex-col items-center justify-center text-gray-600 bg-gray-800/50 rounded-xl border-2 border-dashed border-gray-700 min-h-[200px]">
                <Scissors size={64} className="mb-4 opacity-20"/>
                <p>Selecione uma Bobina Mãe</p>
             </div>
           )}

           {/* --- 4. HISTÓRICO DE CORTES (EMBAIXO, SEMPRE VISÍVEL E COM ALTURA GARANTIDA) --- */}
           <Card className="flex-1 flex flex-col min-h-[350px] overflow-hidden border-t-4 border-purple-500">
             ...
             <div className="space-y-4">
                ...
                <div className="animate-fade-in">
                      <div className="space-y-4">
                        ...
                        {/* GRID DE INPUTS (COM DATA, TOTAL, PADRÃO E SUCATA) */}
